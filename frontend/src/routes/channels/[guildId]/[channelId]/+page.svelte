...
<Scroller messages={data.messages} selectedGuildId={data.guildId} />
...
<!-- <List
    ...
    {#each items as it (it.key)}
        <div style={sty(it.style)}>
			<MessageLoader messageId={data.messages[it.index]._id} selectedGuildId={data.guildId} />
		</div>
    {/each}
</List> -->
  ...
  <!-- <VirtualList
	...
	<div slot="item" let:index let:style {style}>
		<MessageLoader messageId={data.messages[index]._id} selectedGuildId={data.guildId} />
	</div>
	</VirtualList> -->
{/key}
<!-- {#if data.messages}
