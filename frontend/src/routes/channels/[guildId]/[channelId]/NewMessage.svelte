					...
					{:else}
						...
						<div class="chatlog__content chatlog__markdown">
							<span class="chatlog__markdown-preserve"
								>
								<div>{message.content[0].content}</div>
								<!-- <MessageMarkdown content={message.content} {guild} {message} /> -->
								</span
							>
										...
										<div class="chatlog__embed-text">
													...
													{#if embed.url}
														<a class="chatlog__embed-title-link" href={embed?.url}>
															<div class="chatlog__markdown chatlog__markdown-preserve">
																<!-- <MessageMarkdown content={embed.title} {guild} {message} /> -->
															</div>
														</a>
													{:else}
														<div class="chatlog__markdown chatlog__markdown-preserve">
											...
											{#if embed.description}
												<div class="chatlog__embed-description">
													<div class="chatlog__markdown chatlog__markdown-preserve">
														<!-- <MessageMarkdown content={embed.description} {guild} {message} /> -->
													</div>
												</div>
											{/if}
														...
														<div class="chatlog__embed-field">
															{#if field.name}
																<div class="chatlog__embed-field-name">
																	<div class="chatlog__markdown chatlog__markdown-preserve">
																		<!-- <MessageMarkdown content={field.name} {guild} {message} embed={true}/> -->
																	</div>
																</div>
															{/if}
															...
															{#if field.value}
																<div class="chatlog__embed-field-value">
																	<div class="chatlog__markdown chatlog__markdown-preserve">
																		<!-- <MessageMarkdown content={field.value} {guild} {message} embed={true}/> -->
																	</div>
																</div>
															{/if}
														</div>
												...
												{#each embed.images as image}
													<div class="chatlog__embed-images">
														<div class="chatlog__embed-image-container">
															<p>TODO embed.images</p>
															<!-- <ImageGallery asset={image.url} imgclass={"chatlog__embed-image"} /> -->
														</div>
													</div>
												{/each}
											{/if}
							...
							{#each message.reactions as reaction}
								<div class="chatlog__reaction" title={reaction.emoji.name}>
									<img
										...
										loading="lazy"
										width="{reaction.emoji?.image?.width ?? 17}"
										height="{reaction.emoji?.image?.height ?? 17}"
										onerror="this.style.visibility='hidden'"
