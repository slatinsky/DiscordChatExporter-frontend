    ...
    <div class="gallery-wrapper" on:click={()=>showModal=false}>
        ...
        <div id="userselect" on:click|stopPropagation>
            <div id="userselect-inner">
                ...
                {/each}
                {#if users.length == 0}
                    <div style="padding: 10px; color: #909297;">Select a server first to see available users</div>
                {/if}
            </div>
        </div>
    </div>
...
<style>
    ...
    #userselect-inner::-webkit-scrollbar-track {
        background-color: #2b2d31;
    }
    #userselect-inner::-webkit-scrollbar-corner {
        background-color: #646464;
    }
    #userselect-inner::-webkit-resizer {
        background-color: #666;
    }
    #userselect-inner::-webkit-scrollbar {
        width: 0px;
        height: 3px;
    }
    #userselect-inner:hover::-webkit-scrollbar {
        width: 11px;
    }
    #userselect-inner::-webkit-scrollbar-thumb {
        height: 50px;
